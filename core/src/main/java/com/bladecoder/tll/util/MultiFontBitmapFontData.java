...
public final class MultiFontBitmapFontData extends FreeTypeFontGenerator.FreeTypeBitmapFontData {
  ...
  private final List<FreeTypeFontGenerator.FreeTypeBitmapFontData> fallBackBitmapFontData =
      new ArrayList<>();
  private final List<FreeTypeFontGenerator> fallbackFontGenerators = new ArrayList<>();
  private PixmapPacker packer;

  public void addFallBackFont(
      FileHandle fontFile, FreeTypeFontGenerator.FreeTypeFontParameter parameter) {
    FreeTypeFontGenerator.FreeTypeBitmapFontData fallbackData =
        new FreeTypeFontGenerator.FreeTypeBitmapFontData();
  ...
  public void createPacker(FreeTypeFontGenerator.FreeTypeFontParameter parameter) {
    ...
    PixmapPacker packer =
        new PixmapPacker(size, size, Pixmap.Format.RGBA8888, 1, false, packStrategy);
