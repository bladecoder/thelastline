...
public class BlocksUI {
    ...
    public BlocksUI(BladeSkin skin, TLLGame game, BlocksLogic blocksLogic, Theme theme, Viewport viewport, SpriteBatch batch) {
    ...
    private Table createMenu(String titleText, boolean addResume, ButtonGroup<Button> group) {
        ...
        Drawable tableBg = new RectangleDrawable(bgColor, (int)theme.scoresBorderWidth, theme.scoresBorderColor);
    ...
    public void render(float delta) {
        ...
        if(pauseTable == null && (blocksLogic.isPaused() || blocksLogic.getState() == GameState.State.WIN || blocksLogic.getState() == GameState.State.GAME_OVER)) {
            showMenu();
        }
