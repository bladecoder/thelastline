...
import com.bladecoder.tll.util.MultiFontBitmapFontData;
...
public class BladeSkin extends Skin {
   ...
   *
   * <p>Also add the size parameter to support bitmaps font size in pt
   */
  @Override
  protected Json getJsonLoader(final FileHandle skinFile) {
    ...
    json.setSerializer(
        ...
        new ReadOnlySerializer<Skin>() {
          @Override
          public Skin read(
              Json json, JsonValue typeToValueMap, @SuppressWarnings("rawtypes") Class ignored) {
    ...
    json.setSerializer(
        ...
        new ReadOnlySerializer<BitmapFont>() {
          @Override
          public BitmapFont read(
              Json json, JsonValue jsonData, @SuppressWarnings("rawtypes") Class type) {
            ...
            if (fontFile.extension().equalsIgnoreCase("ttf")) {
              ...
              parameter.borderColor =
                  json.readValue("borderColor", Color.class, Color.BLACK, jsonData);
              parameter.borderStraight =
                  json.readValue("borderStraight", boolean.class, false, jsonData);
              ...
              parameter.shadowColor =
                  json.readValue("shadowColor", Color.class, Color.BLACK, jsonData);
              if (parameter.incremental) parameter.characters = "";

              ArrayList<String> fallbacksFonts =
                  json.readValue("fallbacks", ArrayList.class, String.class, jsonData);
              ...
              if (fontGenerators == null) fontGenerators = new ArrayList<>();
              ...
              try {
                ...
                if (scaledSize != -1) font.getData().setScale(scaledSize / font.getCapHeight());
                  ...
                  font.getData()
                      .setScale(
                          (DPIUtils.dpToPixels(size) * DPIUtils.getSizeMultiplier())
                              / font.getCapHeight());
    ...
    json.setSerializer(
        ...
        new ReadOnlySerializer<AnimationDrawable>() {
          @Override
          public AnimationDrawable read(
              Json json, JsonValue jsonData, @SuppressWarnings("rawtypes") Class type) {
            String name = json.readValue("name", String.class, jsonData);
            float duration = json.readValue("duration", Float.class, 1f, jsonData);
            PlayMode playMode =
                json.readValue("play_mode", PlayMode.class, PlayMode.LOOP, jsonData);
            ...
            drawable.setName(jsonData.name + " (" + name + ", " + duration + ")");
